AddEvent("OnKeyPress", function(key)
    ...
    if key == "R" then
        local x1, y1, z1 = GetPlayerLocation(GetPlayerId())
        local coll1 = CreateCollisionBox(128267, 77617, 1547, 128012, 77621,
                                         1535, true)
    end
    ...
    if key == "1" then
        local SkeletalMeshComponent = GetPlayerSkeletalMeshComponent(
                                          GetPlayerId(), "Body")
        SkeletalMeshComponent:SetSkeletalMesh(
            USkeletalMesh.LoadFromAsset(
                "/Game/CharacterModels/Military/Meshes/SK_SpecialForces01"))
        ...
        SkeletalMeshComponent = GetPlayerSkeletalMeshComponent(GetPlayerId(),
                                                               "Clothing0")
    ...
    if key == "2" then
        ...
        SkeletalMeshComponent:SetMaterial(0, UMaterialInterface.LoadFromAsset(
    ...
    if key == "3" then
        ...
        SkeletalMeshComponent:SetMaterial(3, UMaterialInterface.LoadFromAsset(
                                              "/Game/CharacterModels/Materials/HZN_Materials/M_HZN_Body_NoShoesLegsTorso"))
        ...
        SkeletalMeshComponent:SetSkeletalMesh(
            USkeletalMesh.LoadFromAsset(
                "/Game/CharacterModels/SkeletalMesh/Outfits/HZN_Outfit_Piece_BusinessShoes_LPR"))
        local DynamicMaterialInstance =
            SkeletalMeshComponent:CreateDynamicMaterialInstance(0)
        DynamicMaterialInstance:SetColorParameter("Clothing Color",
    ...
    if key == "4" then
        ...
        local DynamicMaterialInstance =
            SkeletalMeshComponent:CreateDynamicMaterialInstance(2)
        DynamicMaterialInstance:SetColorParameter("Clothing Color",
                                                  FLinearColor(0.0, 1.0, 0.0,
                                                               1.0))
        DynamicMaterialInstance =
            SkeletalMeshComponent:CreateDynamicMaterialInstance(3)
        DynamicMaterialInstance:SetColorParameter("Clothing Color",
    ...
    if key == "5" then
        ...
        SkeletalMeshComponent:SetSkeletalMesh(
            USkeletalMesh.LoadFromAsset(
                "/Game/CharacterModels/Alien/Meshes/SK_Alien01"))
